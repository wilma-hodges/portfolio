...
<script type="text/javascript">
	...
	var colourChanger = new function() {
		...
		this.init = function() {
			...
			//populate wcag logo and link and/or hide it from wizard values
			...
			if (x_params.wcagLink != undefined && x_params.wcagLink != ""){
				$(".wcagLink").prop("href",x_params.wcagLink);
			}
			if (x_params.wcagHide != undefined && x_params.wcagHide == 'true'){
				$('.wcagLink').remove();
			}
		...
		this.switchTheme = function(theme){
            ...
            if (theme == 'highcontrast' || theme == 'blackonyellow')
			{
...
<div id="colourChangerHolder" aria-live="polite">
	<p id="p1"></p>
	<div id="optionHolder">
